...
elseif (${_len} GREATER 1)
	...
	list(GET TOTAL_TIMER_INSTANCES 0 XILTIMER_sleep_timer)
	...
	if (${index} EQUAL ${_len})
		...
		list(GET TOTAL_TIMER_INSTANCES ${index} XILTIMER_tick_timer)
	else()
		message("${index}")
		list(GET TOTAL_TIMER_INSTANCES ${index} XILTIMER_tick_timer)
	endif()
...
elseif (${_len} EQUAL 1)
	...
	(${XILTIMER_en_interval_timer}))
        ...
        set(XTIMER_IS_DEFAULT_TIMER 1)
    elseif(NOT ("${XILTIMER_sleep_timer}" STREQUAL "Default"))
        set(XTIMER_NO_TICK_TIMER 1)
        list(GET TOTAL_TIMER_INSTANCES 0 XILTIMER_sleep_timer)
