...
set( CMAKE_C_FLAGS " -mlittle-endian -mxl-barrel-shift -mxl-pattern-compare -mxl-reorder -mcpu=v10.0 -mno-xl-soft-mul -mxl-multiply-high -mno-xl-soft-div -Os -flto -ffat-lto-objects  -DVERSAL_PLM=1 -specs=${CMAKE_BINARY_DIR}/../src/scripts/specs/microblaze/Xilinx.spec -I${CMAKE_INCLUDE_PATH}" CACHE STRING "CFLAGS" )
set( CMAKE_CXX_FLAGS " -mlittle-endian -mxl-barrel-shift -mxl-pattern-compare -mxl-reorder -mcpu=v10.0 -mno-xl-soft-mul -mxl-multiply-high -mno-xl-soft-div -Os -flto -ffat-lto-objects -DVERSAL_PLM=1 -specs=${CMAKE_BINARY_DIR}/../src/scripts/specs/microblaze/Xilinx.spec" CACHE STRING "CFLAGS" )
set( CMAKE_ASM_FLAGS " -mlittle-endian -mxl-barrel-shift -mxl-pattern-compare -mxl-reorder -mcpu=v10.0 -mno-xl-soft-mul -mxl-multiply-high -mno-xl-soft-div -Os -flto -ffat-lto-objects -DVERSAL_PLM=1 -specs=${CMAKE_BINARY_DIR}/../src/scripts/specs/microblaze/Xilinx.spec -I${CMAKE_INCLUDE_PATH}" CACHE STRING "ASM FLAGS" )
