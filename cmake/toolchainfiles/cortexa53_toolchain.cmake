set( CMAKE_LIBRARY_PATH "$ENV{WORKSPACE}/psu_cortexa53_0/lib/")
set( CMAKE_INCLUDE_PATH "$ENV{WORKSPACE}/psu_cortexa53_0/include/")
...
set( CMAKE_C_FLAGS " -mcpu=cortex-a53 -march=armv8-a+crc -O2 -pipe -g -feliminate-unused-debug-types -specs=$ENV{REPO}/scripts/specs/arm/Xilinx.spec -I${CMAKE_INCLUDE_PATH} " CACHE STRING "CFLAGS" )
set( CMAKE_CXX_FLAGS " -mcpu=cortex-a53 -march=armv8-a+crc -O2  -pipe -g -feliminate-unused-debug-types -specs=$ENV{REPO}/scripts/specs/arm/Xilinx.spec" CACHE STRING "CFLAGS" )
set( CMAKE_ASM_FLAGS " -mcpu=cortex-a53 -march=armv8-a+crc -O2 -pipe -g -feliminate-unused-debug-types -specs=$ENV{REPO}/scripts/specs/arm/Xilinx.spec -I${CMAKE_INCLUDE_PATH}" CACHE STRING "ASM FLAGS" )
