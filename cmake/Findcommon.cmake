...
function (linker_gen path)
	...
	if (${NON_YOCTO})
	    ...
	    execute_process(COMMAND ${CMAKE_COMMAND} -E copy ${LINKER_FILE_PATH} ${CMAKE_SOURCE_DIR}/tmp)
	    file (REMOVE_RECURSE ${path})
	    file (MAKE_DIRECTORY ${path})
	    # since move command is not there copy back and delete unneeded files
	    execute_process(COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/tmp/${LINKER_FILE} ${path})
	    if(("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "cortexr5"))
		    execute_process(COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/tmp/${R5_LINKER_FILE} ${path})
	    endif()
