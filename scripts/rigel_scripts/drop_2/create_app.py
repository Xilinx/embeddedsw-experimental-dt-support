...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate App the ',
                                     usage='use "python %(prog)s --help" for more information',
                                     formatter_class=argparse.RawTextHelpFormatter)
    required_argument = parser.add_argument_group('Required arguments')
    required_argument.add_argument('-domain', '--domain_path', action='store',help='Platform Workspace directory', required=True)
    required_argument.add_argument('-w', '--wsdir', action='store',help='Workspace directory', required=True)
    required_argument.add_argument('-name', '--name', action='store',help='Provide an app name', required=True)
    required_argument.add_argument('-template', '--template', action='store', help='Specify template app name', required=True)
