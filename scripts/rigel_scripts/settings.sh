...
export XBUILDS_LOPPER_PATH=/proj/xhdsswstaff/appanad/repos/decoupling_repo/lopper_artifacts
...
export OSF="True"
export ESW_REPO=/proj/xhdsswstaff/appanad/repos/decoupling_repo/esw_sdt_repo/rebase_2023/embeddedsw-experimental-dt-support
